...
// Create the techtonic plate layer for our map.
...
// Accessing the Tectonic Plate Boundaries JSON file from fraxen on Github
...
d3.json(plateData).then(function(data) {
 ...
 // Add techtonic layer to the map
 tectonic.addTo(map);
});